...
const LocationScreen = () => {
  ...
  const fetchFloors = async () => {
    ...
    try {
      const response = await axios.get(
        "http://35.223.244.137:8000/v1/assets/floor/all",
        {
          headers: {
  ...
  const fetchFloorData = async (floor) => {
    ...
    try {
      const response = await axios.get(
        `http://35.223.244.137:8000/v1/assets/floor/${floor}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDepartmentPress = async (department) => {
    ...
    try {
      const response = await axios.get(
        `http://35.223.244.137:8000/v1/assets/floor/${selectedFloor}/${encodeURIComponent(
